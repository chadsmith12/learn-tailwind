    ...
    <div class="bg-gray-100 flex">
        <div class="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:w-full lg:w-1/2 lg:py-24 lg:px-12">
            <div class="xl:max-w-lg xl:ml-auto">
                ...
                <img class="mt-6 rounded-lg shadow-xl sm:mt-8 sm:h-72 sm:w-full sm:object-cover sm:object-center lg:hidden" src="img/beach-work.jpg" alt="Women workcationing on the beach">
                <h1 class="mt-6 text-2xl font-bold text-gray-900 leading-tight sm:mt-8 sm:text-4xl lg:text-3xl xl:text-4xl">
                    You can work from anywhere. 
                    <br class="hidden lg:inline"><span class="text-brand-blue-100">Take advantage of it.</span>
                </h1>
                ...
                <div class="mt-4 sm:mt-6">
                    <a class="btn btn-brand-blue text-white shadow-lg sm:text-base" href="#">
                        Book your escape!
                    </a>
                    <a class="ml-2 btn btn-gray shadow-lg sm:text-base" href="#">
                        Learn More
                    </a>
                </div>
            </div>
        ...
        <div class="hidden lg:block lg:w-1/2 lg:relative">
            <img class="absolute inset-0 w-full h-full object-cover object-center" src="img/beach-work.jpg" alt="Women workcationing on the beach">
        </div>
    </div>
    <div>
      <div class="max-w-md sm:max-w-xl lg:max-w-6xl mx-auto px-8 lg:px-12 py-8">
        ...
        <div class="flex flex-wrap -mx-4">
          ...
          <destination-card :destination="destination"></destination-card>
          </div>
        </div>
      </div>
    </div>
