    ...
    <div class="bg-gray-100 flex">
        <div class="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:w-full lg:w-1/2 lg:py-24 lg:px-12">
            <div class="xl:max-w-lg xl:ml-auto">
                ...
                <img class="mt-6 rounded-lg shadow-xl sm:mt-8 sm:h-64 sm:w-full sm:object-cover sm:object-center lg:hidden" src="img/beach-work.jpg" alt="Women workcationing on the beach">
                ...
                <div class="mt-4 sm:mt-6">
                    <a class="btn btn-indigo shadow-lg sm:text-base" href="#">
                        Book your escape!
                    </a>
